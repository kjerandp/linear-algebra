 ...
 * @param {Array<Array>} vectors Array of equally length arrays/vectors (to be added)
 * @param {Array} target optional array/vector to add into
 * @return {Array} array/vector
 */
 ...
 * be mutated. Target will be overwritten and NOT included in the sum.
 * @param {Array} from left operand
 * @param {Array<Array>} vectors right operand
 * @param {Array} target optional array/vector to store the result
 * @return {Array} array/vector
 */
 ...
 * @param {Array} from start coordinates
 * @param {Array} to end coordinates
 * @param {Array} target optional array/vector to store the resulting vector
 ...
 * @param {Array} arr array/vector to scale
 * @param {number} factor scaling factor
 * @param {Array} target optional array/vector to store the result
 * @return {Array} scaled array/vector
 */
 ...
 * @param {Array} arr array/vector to compute
 * @return {number}
 */
 ...
 * @param {Array} vector array/vector to compute
 * @return {number}
 */
 ...
 * @param {Array} vector array/vector to notmalize
 * @param {Array} target optional array/vector to store the result
 * @return {Array} normalized array/vector
 */
 ...
 * @param {Array} to end coordinates
 * @param {Array} target optional array/vector to store the result
 * @return {Object} vector, sum of squares, distance and unit vector
 */
 ...
 * @param {Array} vector 2d vector
 * @param {Array} target optional array/vector to store the resulting vector
 * @return {Vector} normalized, perpendicular vector
 */
 ...
 * @param {Array} to end coordinates
 * @param {Array} target optional array/vector to store the resulting vector
 * @return {Vector} unit vector between from and to
 */
 ...
 * @param {Array} p1 point/coordinates
 * @param {Array} p2 point/coordinates
 ...
 * @param {Array} v1 left hand operand
 * @param {Array} v2 right hand operand
 ...
 * @param {Array} v1 left hand operand (3d vector)
 * @param {*} v2 right hand operand (3d vector)
 * @param {Array} target optional array/vector to store the resulting vector
 * @return {Array} the cross product vector (normal)
 */
 ...
 * @param {Array} v1 left hand operand for the dot product (3d vector)
 * @param {Array} v2 left hand operand for the cross product (3d vector)
 * @param {Array} v3 right hand operand for the cross product (3d vector)
 ...
 * @param {Array} v1 left hand operand (2d vector)
 * @param {Array} v2 right hand operand (2d vector)
 ...
 * @param {Array} arr values to clamp
 * @param {number} min minimum value
 * @param {number} max maximum value
 * @param {Array} target optional array/vector to store the result
 * @return {Array} array of clamped values
 */
 ...
 * @param {number/Array} arg value or array of values to clamp
 * @param {number} min minimum value
 * @param {number} max maximum value
 * @param {Array} target optional array/vector to store the result
 * @return {number/Array} clamped version of arg
 */
 ...
 * @param {Array} edges values to test
 * @param {Array/number} x threshold values
 * @param {Array} target optional array/vector to store the result
 * @return {Array} results for each value in edges
 */
 ...
 * @param {number/Array} edge number/array to test
 * @param {number/Array} x threshold(s)
 * @param {Array} target optional array/vector to store the result (if edge is array)
 * @return {number/Array}
 */
 ...
 * @param {Array} a interpolate from
 * @param {Array} b interpolate to
 * @param {number/Array} t time 0 = a, 1 = b
 * @param {Array} target optional array/vector to store the result
 * @return {Array} interpolated array/vector/matrix
 */
 ...
 * matrices as well.
 * @param {number/Array} v value to round
